...
plot  filename(i) u 1:2  w  lp  ls 10 t 'Rupture de barrage ' , filename(i) u 1:4 w lp ls 11 t 'Fond'  #Dam Break u 1:2
}
...
plot  fichier(i) u 1:2  w  lp  ls 10 t 'Rupture de barrage',  filename(i) u 1:4 w lp ls 11 t 'Fond' #Dam Break u 1:2
}
...
plot  file(i) u 1:2  w  lp  ls 10 t 'Rupture de barrage' ,  filename(i) u 1:4 w lp ls 11 t 'Fond' #Dam Break u 1:2
}
