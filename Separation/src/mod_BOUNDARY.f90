...
!!$       !Tab(0)%u = 0.0d0
!!$       Tab(0)%qx = 0.1d0 !4.42d0
!!$       !Tab(0)%h = 1.0d0 !1.0d0 + 1.0d-01*(cos((8/(1.0d0*5.0d-02))*atan(1.0d0)*(time)))
!!$       !CONDITION GAUCHE
!!$
!!$
!!$       allocate(te(N) , yy(N))
...
!!$       Tab(-2)%qx = Tab(-1)%qx
       ...
       !Tab(Nbx+1)%h = 1.0d0 + 1.0d-01*(cos((8/(1.0d0*5.0d-02))*atan(1.0d0)*(time))) !2.0d0! 1.0d0 !2.0d0 !1.0d0 !
       Tab(Nbx+1)%u = 0.0d0
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!      
       !Tab(0)%u = 0.0d0
       Tab(1)%qx = 0.1d0 !0.0d0 !0.1d0 !4.42d0
