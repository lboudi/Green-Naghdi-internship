MODULE modCommon
  ...
  TYPE(Data_In), PUBLIC :: DATA_N
  TYPE(MeshDef), PUBLIC :: MESH_N
  TYPE(MyRun), PUBLIC :: Run , Run_N
  !TYPE(Diffusion), PUBLIC :: visc
  TYPE(VFLU), PUBLIC :: FLU
  TYPE(Variable), PUBLIC :: Var
  TYPE(VFLU), PUBLIC :: FLU_N
  TYPE(Variable), PUBLIC :: Var_N
  ...
  TYPE(coeff_RK), DIMENSION(4) :: RK , RK_N
