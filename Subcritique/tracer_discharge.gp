...
plot  'SOL1D_proc0.0.res'  u 1:6  w  lp  ls 12 t 'Debit'

filename(n) = sprintf('SOL1D_proc0.%05.0f.res',n)

sortie(n) = sprintf('SOL1D_proc0.%05.0f.pdf',n)
...
fichier(n) = sprintf('SOL1D_proc0.%06.0f.res',n)

out(n) = sprintf('SOL1D_proc0.%06.0f.pdf',n)
