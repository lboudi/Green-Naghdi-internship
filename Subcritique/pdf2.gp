...
set xlabel "x(m)"
set ylabel "y(m)"
filename(n) = sprintf('SOL1D_proc0.%04.0f.res',n)

sortie(n) = sprintf('SOL1D_proc0.%04.0f.pdf',n)
...
file(n) = sprintf('SOL1D_proc0.%05.0f.res',n)

sort(n) = sprintf('SOL1D_proc0.%05.0f.pdf',n)
