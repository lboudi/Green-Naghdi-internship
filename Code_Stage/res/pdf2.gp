...
set xlabel "x(m)"
set ylabel "y(m)"
filename(n) = sprintf('SOL1D.%04.0f.res',n)

sortie(n) = sprintf('SOL1D.%04.0f.pdf',n)
...
plot  filename(i) u 1:5  w  lp  ls 10 t 'Surface eau' ,  filename(i) u 1:4  w  lp  ls 11 t 'Fond'
i = i + 10000
}
...
file(n) = sprintf('SOL1D.%05.0f.res',n)

sort(n) = sprintf('SOL1D.%05.0f.pdf',n)
...
plot  file(i) u 1:5  w  lp  ls 10 t 'Surface eau' ,  filename(i) u 1:4  w  lp  ls 11 t 'Fond'
i = i + 10000
}



fi(n) = sprintf('SOL1D.%06.0f.res',n)

so(n) = sprintf('SOL1D.%06.0f.pdf',n)
...
plot  fi(i) u 1:5  w  lp  ls 10 t 'Surface eau' ,  fi(i) u 1:4  w  lp  ls 11 t 'Fond'
i = i + 10000
}
...
set output 'invariant.pdf'
plot 'invariant.res' u 1:2 w lp ls 10 t 'invariant-', 'invariant.res' u 1:3 w lp ls 11 t 'invariant+'
