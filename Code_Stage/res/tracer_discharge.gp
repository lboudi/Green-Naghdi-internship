...
plot  'SOL1D.0.res'  u 1:6  w  lp  ls 12 t 'Debit'
...
plot  filename(i) u 1:6  w  lp  ls 12 t 'Debit'  #Dam Break u 1:2
}
...
plot  fichier(i) u 1:6  w  lp  ls 12 t 'Debit'
}
...
plot  fi(i) u 1:6  w  lp  ls 12 t 'Debit'
i = i + 10000
}
