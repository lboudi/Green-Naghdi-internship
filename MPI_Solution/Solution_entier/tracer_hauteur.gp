...
set style line 12 linetype 1 linecolor rgb "#00994D" lw 1
...
plot  'SOL1D.0.res'  u 1:2  w  lp  ls 12 t 'Hauteur eau', 'SOL1D.0.res'   u 1:4  w  lp  ls 11 t 'Fond'
...
plot  filename(i) u 1:2  w  lp  ls 12 t 'Hauteur eau',  filename(i) u 1:4  w  lp  ls 11 t 'Fond'  #Dam Break u 1:2
}

fichier(n) = sprintf('SOL1D.%05.0f.res',n)

out(n) = sprintf('SOL1D.%05.0f.pdf',n)
...
plot  fichier(i) u 1:2  w  lp  ls 12 t 'Hauteur eau' ,  fichier(i) u 1:4  w  lp  ls 11 t 'Fond'
}
...
#plot  file(i) u 1:6  w  lp  ls 10 t 'Discharge'
#}
