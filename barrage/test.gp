...
plot   'SOL1D_proc0.0.res'  u 1:5  w  lp  ls 10 t 'Surface libre' ,  'SOL1D_proc0.0.res' u 1:4 w lp ls 11 t 'Fond'  #Dam Break u 1:2
...
plot  filename(i) u 1:5  w  lp  ls 10 t 'Surface libre' , filename(i) u 1:4 w lp ls 11 t 'Fond'  #Dam Break u 1:2
}
...
plot  fichier(i) u 1:5  w  lp  ls 10 t 'Surface libre',  filename(i) u 1:4 w lp ls 11 t 'Fond' #Dam Break u 1:2
}
...
plot  file(i) u 1:5  w  lp  ls 10 t 'Surface libre' ,  filename(i) u 1:4 w lp ls 11 t 'Fond' #Dam Break u 1:2
}




fi(n) = sprintf('SOL1D_proc0.%05.0f.res',n)

sor(n) = sprintf('SOL1D_proc0.%05.0f.pdf',n)
...
plot  fi(i) u 1:5  w  lp  ls 10 t 'Surface libre' ,  filename(i) u 1:4 w lp ls 11 t 'Fond' #Dam Break u 1:2
}
