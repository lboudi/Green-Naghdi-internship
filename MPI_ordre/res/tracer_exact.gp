...
plot  filename(i) u 1:2  w  lp  ls 10 t 'subcritical flow ' , filename(i) u 1:8 w lp ls 11 t 'approche'  #Dam Break u 1:2
}
...
plot  fichier(i) u 1:2  w  lp  ls 10 t 'subcritical flow',  filename(i) u 1:8 w lp ls 11 t 'approche' #Dam Break u 1:2
}
...
plot  file(i) u 1:2  w  lp  ls 10 t 'subcritical flow' ,  filename(i) u 1:8 w lp ls 11 t 'approche' #Dam Break u 1:2
}
