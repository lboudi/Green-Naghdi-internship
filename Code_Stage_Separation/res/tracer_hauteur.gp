...
plot  'SOL1D.0.res'  u 1:2  w  lp  ls 12 t 'Hauteur eau'
...
plot  filename(i) u 1:2  w  lp  ls 12 t 'Hauteur eau'  #Dam Break u 1:2
}
...
plot  fichier(i) u 1:2  w  lp  ls 12 t 'Hauteur eau'
}
